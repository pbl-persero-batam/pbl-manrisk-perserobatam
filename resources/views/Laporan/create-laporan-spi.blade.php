<div class="form-group">
    <!-- Modal -->
    <div class="modal fade text-left" id="tambahLaporan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel17"><strong>Tambah Laporan SPI</strong></h4>
