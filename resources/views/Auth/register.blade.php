...
<div class="app-content content">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal" action="{{ route('register') }}" method="POST" novalidate>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control input-lg" id="name" name="name" placeholder="Full Name" tabindex="1" required data-validation-required-message="Please enter your full name.">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="email" class="form-control input-lg" id="email" name="email" placeholder="Email" tabindex="2" required data-validation-required-message="Please enter your email.">
                                            <div class="form-control-position">
                                                <i class="ft-mail"></i>
                                            </div>
                                            <div class="help-block font-small-3"></div>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control input-lg" id="password" name="password" placeholder="Password" tabindex="3" required data-validation-required-message="Please enter a password.">
                                            <div class="form-control-position">
                                                <i class="fa fa-key"></i>
                                            </div>
                                            <div class="help-block font-small-3"></div>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control input-lg" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password" tabindex="4" required data-validation-required-message="Please confirm your password.">
                                            <div class="form-control-position">
                                                <i class="fa fa-key"></i>
                                            </div>
                                            <div class="help-block font-small-3"></div>
    ...
    <p class="card-subtitle text-muted text-center mx-2 my-1">
        <span class="font-small-5">Already have an account? <a href="/login">Sign In</a></span>
    </p>
</div>
